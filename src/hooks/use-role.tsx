...
export const ALL_MODULES: { key: string; label: string; group: string }[] = [
  ...
  { key: "salary_bonus_pending", label: "Persetujuan Bonus", group: "Gaji" },
  { key: "supplier_returns", label: "Retur ke Supplier", group: "Supplier" },
  ...
  { key: "reports_bonus", label: "Laporan Bonus Barang", group: "Laporan" },
  { key: "reports_returns", label: "Laporan Retur Supplier", group: "Laporan" },
